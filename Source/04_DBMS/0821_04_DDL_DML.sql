...
/* SQL
    ...
    (3) DML : CRUD
        입력(INSERET), 수정(UPDATE), 삭제(DELETE) - 취소(ROLLBACK) 가능
        검색(SELECT)
*/
----------------
--- ★ DDL ★ ---
...
CREATE TABLE BOOK(
    ...
    PRICE     NUMBER(8,2),   -- PRICE 필드의 타입은 숫자 전체8자리 중 소숫점 2자리
...
SELECT * FROM DEPT1;
INSERT INTO DEPT1 VALUES (40, '법무', 'SEOUL');  -- PK 제약 조건 에러
UPDATE DEPT1 SET DNAME='SALES' WHERE DEPTNO=40; -- UNIQUE 제약조건 에러
INSERT INTO DEPT1 (DEPTNO, DNAME) VALUES (50, '전산'); -- 묵시적으로 LOC에 NULL을 입력 -- NOT NULL 제약조건 에러
